...
function updateLifeTimer(){
    ...
    document.getElementById("lifeHours").innerText = hours;
    document.getElementById("lifeMinutes").innerText = minutes;
    document.getElementById("lifeSeconds").innerText = seconds;
